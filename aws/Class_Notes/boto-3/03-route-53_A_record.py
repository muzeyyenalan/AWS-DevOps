...
# set instance ID
instance_id = 'xxxxxxxxxxxxxxxxx' # Instance ID, e.g. 'i-0111112233'
# set Hosted Zone ID
zone_id = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxx' # Hosted Zone ID, e.g. 'ZBDAAABBBCCC'
# domain
domain = 'xxxxxxxxxxxxxxxxxxxxxxx' # Domain, e.g. technoff.eu
